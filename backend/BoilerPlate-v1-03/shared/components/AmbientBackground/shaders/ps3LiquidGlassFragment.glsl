...
const float PARALLAX_STRENGTH = 0.06;
...
// --- GLASS REFLECTION CALCULATION ---
// Simulates the glossy, reflective quality of the PS3 interface
...
void main() {
    ...
    for (float i = 0.0; i < 8.0; i++) {
        ...
        bokehAccum += b * 0.15;
        bokehColor += bColor * b * 0.15;
    }
    
    color += bokehColor;
    
    // --- 5. AMBIENT LIGHT WASH ---
